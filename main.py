...
newList=["Adrian", "Sam", "openssh", "172.18.0.54"]
...
print(guardiansOfGalaxy.reverse())
print(guardiansOfGalaxy)
guardiansOfGalaxy.remove("Gamora")
print(guardiansOfGalaxy)
print(guardiansOfGalaxy.index("Drax"))
